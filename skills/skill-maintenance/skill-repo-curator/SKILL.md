...
- Inspect the skill tree, catalog docs, validation scripts, local helper lockfiles, and install smoke-test output.
...
- Do not vendor already-published upstream skills into `skills/`; use project-local `npx skills` installs and `skills-lock.json`.
