...
Variants: [Short](0051-preserve-release-candidates-through-verified-main-history.short.md) · [Long, canonical](0051-preserve-release-candidates-through-verified-main-history.long.md) · **Guide**

This guide is non-normative. [Long](0051-preserve-release-candidates-through-verified-main-history.long.md) is the authoritative decision; if this guidance conflicts with it, follow Long.
