...
Variants: [Short](0012-use-agent-skills-repository-slug.short.md) · [Long, canonical](0012-use-agent-skills-repository-slug.long.md) · **Guide**

This guide is non-normative. [Long](0012-use-agent-skills-repository-slug.long.md) is the authoritative decision; if this guidance conflicts with it, follow Long.
