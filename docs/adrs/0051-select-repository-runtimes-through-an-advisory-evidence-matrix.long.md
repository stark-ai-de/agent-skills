...
Variants: [Short](0051-select-repository-runtimes-through-an-advisory-evidence-matrix.short.md) · **Long, canonical** · [Guide](0051-select-repository-runtimes-through-an-advisory-evidence-matrix.guide.md)
...
- AC-ADR-055 and ADR-0050 deliberately provide a Bun-first repository-tooling candidate and a verified-fallback contract.
...
- Changing a winner updates the matrix, owning command, focused evidence, and affected docs together without rewriting ADR-0050 unless package ownership or Bun's candidate status changes.
...
- Benefit: AC-ADR-014 and AC-ADR-055 remain independently useful and jointly actionable.
