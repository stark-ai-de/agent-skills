...
Create a successor if persistent package ownership moves away from pnpm or Bun ceases to be the repository's starting candidate. Change a per-boundary winner through ADR-0051's matrix and owning checks without rewriting this accepted decision.
