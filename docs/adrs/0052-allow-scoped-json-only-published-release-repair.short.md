...
Variants: **Short** · [Long, canonical](0052-allow-scoped-json-only-published-release-repair.long.md) · [Guide](0052-allow-scoped-json-only-published-release-repair.guide.md)
