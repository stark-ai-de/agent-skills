...
- Keep non-public maintainer repositories and paths, private reference mappings, private source challenge notes and identifying raw artifacts in ignored local provenance artifacts.
