...
The product chart shows Jev, the published Hussi chooser and Native. Our unpublished pooled-HTTPS control remains in the complete table: its median was about 1.5 ms below Jev’s. This is a transport experiment, not a released product or qualified MCP integration.
