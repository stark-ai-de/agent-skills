...
- [`hetzner-inference-setup-skill-spec.md`](hetzner-inference-setup-skill-spec.md) - public Hetzner skill with local/remote LiteLLM, autonomous/manual routes, client adapters, separated credentials, live evidence, and owned rollback.
