...
```json
{
  ...
  "outputs": {
    ...
    "openaiArchive": "dist/openai/stark-ai-developer-1.2.0.zip",
...
skills/<category>/<skill>/          canonical author-maintained skills, including agents/openai.yaml
        ...
        └── plugins/stark-ai-developer.source.json  membership and plugin identity
                ...
                │       └── skills/<skill>/
                │
                ├── dist/openai/stark-ai-developer-1.2.0.zip
...
`pnpm run build:release-subjects` command writes the subject set to
