...
- Catalogs, validator inventory, lineage, locks, component versions, instructions, and generated projections are synchronized where required; root release preparation remains with Release Please.
