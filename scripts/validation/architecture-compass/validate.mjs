...
const errors = [];
const expectedAdrIds = [...Array.from({ length: 63 }, (_, index) => index + 1), 65];
...
const baselineEvalCases = [
  ...
  "chatgpt-plan-live-incident-replay.md",
  "chatgpt-plan-product-label-only.md",
  "chatgpt-plan-missing-slash-not-unavailable.md",
  "chatgpt-plan-goal-and-plan-skill.md",
  "chatgpt-plan-nonslash-native-control.md",
  "chatgpt-plan-mobile-indeterminate.md",
  "chatgpt-plan-observed-slash-handoff.md",
  "chatgpt-plan-none-proven-unavailable.md",
  "chatgpt-plan-observed-control-state-unknown.md",
  "chatgpt-plan-web-slash-control.md",
  "chatgpt-plan-codex-web-observed-slash-handoff.md",
  "chatgpt-plan-codex-web-observed-inline-handoff.md",
  "chatgpt-plan-busy-composer-wait.md",
  "chatgpt-plan-active-busy-composer.md",
  "chatgpt-plan-active-enforcement-unknown.md",
  "chatgpt-plan-active-enforcement-enforced.md",
  "chatgpt-plan-active-enforcement-writable.md",
  "chatgpt-plan-desktop-standalone-transition.md",
