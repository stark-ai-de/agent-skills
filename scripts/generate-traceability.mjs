...
const REQUIREMENTS = [
  ...
  },
  {
    ...
    commands: ["validate:openai-plugin", "validate:openai-listing"],
  },
  {
    id: "MKT-001",
  ...
  {
    id: "EVAL-001",
    contract: "Activation, non-activation, capability, and mutation thresholds",
    commands: ["validate:plugin-evals"],
  },
  {
    id: "SEC-001",
