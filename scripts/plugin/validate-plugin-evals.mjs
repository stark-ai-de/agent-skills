...
const evalRoot = pluginArtifactPaths(root).evalRoot;
const inventoryPath = path.join(root, evalRoot, "manifest.json");
const evidenceReadme = path.join(root, evalRoot, "evidence", "README.md");
