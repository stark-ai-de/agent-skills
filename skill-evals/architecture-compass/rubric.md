...
| Setup-mode support  | Does not install durable guardrails          | Creates partial ADR or agent docs              | Creates/updates agent instructions, ADR index, stack rules where relevant, future prompts, and validation notes |
