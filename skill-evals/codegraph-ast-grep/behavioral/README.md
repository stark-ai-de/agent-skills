...
satisfied the committed assertions for four fixed prompts. The current v0.3.3
suite is an authorized local metadata-and-packaging refresh over synthetic fixture facts,
