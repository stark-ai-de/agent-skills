...
This remains internal evidence, not an external codex-exec run, no-skill or
...
synthetic; no network or analysis tool executed during the refresh. The
neighboring v0.2 captures remain separate historical evidence.

Evidence boundary: not an external codex-exec run, CI result, hosted result, or production proof.
