...
Create a new expressive, hand-drawn comet mark for the Comet Notes README. There is no existing logo or reference image. Check the live Recraft option and show the current one-output cost before asking me to approve anything. Do not generate yet.
...
- Make no paid call while approval is pending; use the direct local route if live facts are unavailable or indeterminate.
