...
- Distinguishes candidate `AGENTS.md` presence, native capability, applicable settings, and actual session loading; preserves imports for older/restricted hosts.
