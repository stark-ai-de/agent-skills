...
Plan and run a persisted Cursor context cleanup. Native Plan mode is supported but inactive. Start the read-only review now; recommend a mode change if useful, without waiting for it.
