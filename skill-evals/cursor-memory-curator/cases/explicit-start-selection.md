...
Show all eight workflows in canonical order; recommend `review-chat` for this bare invocation. Because the request does not identify review versus cleanup or delivery, ask the user to choose without inventorying, scanning, or reading Cursor context.
