...
- Host coverage: ChatGPT Chat/Work/mobile remains observation-gated, and Codex
  ...
  current-composer `/plan` observation, with inline parsing observed separately; an explicit `unknown` surface or
...
- `cases/chatgpt-plan-codex-web-observed-inline-handoff.md`
- `cases/chatgpt-plan-busy-composer-wait.md`
- `cases/chatgpt-plan-active-busy-composer.md`
- `cases/chatgpt-plan-active-enforcement-unknown.md`
- `cases/chatgpt-plan-active-enforcement-enforced.md`
- `cases/chatgpt-plan-active-enforcement-writable.md`
- `cases/chatgpt-plan-desktop-standalone-transition.md`
- `cases/chatgpt-plan-refusal-without-control-evidence.md`
- `cases/chatgpt-plan-codex-web-refusal-docs-only.md`
- `cases/chatgpt-plan-refusal-unknown-surface.md`
- `cases/chatgpt-plan-refusal-unknown-experience.md`
...
For Codex CLI, IDE, and desktop, positive cases use the existing multi-turn native lifecycle:
